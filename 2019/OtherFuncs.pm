...
sub gen_tlspm :Export(:DEFAULT) {
  unlink $G::tlspm if (-f $G::tlspm);
...
=cut
  ...
  print $fp "        <p>Notes:</p>\n";
  print $fp "        <ol>\n";
  print $fp "          <li>$G::GREP_noteH</li>\n";
  print $fp "          <li>$G::GREP_noteJ</li>\n";
  print $fp "          <li>$G::GREP_noteO</li>\n";
...
sub build_class_officers_pages :Export(:DEFAULT) {
  # two pages
